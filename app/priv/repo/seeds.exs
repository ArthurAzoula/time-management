...
defmodule Seeds do
  ...
  defp generate_working_times(userId, start_date) do
    Enum.each(0..4, fn day_offset ->
      ...
      morning_end = Timex.to_naive_datetime(Timex.shift(morning_start, hours: :rand.uniform(4) + 2, minutes: :rand.uniform(60)))
      afternoon_start = Timex.to_naive_datetime(Timex.shift(morning_end, hours: 1))
      afternoon_end = Timex.to_naive_datetime(Timex.shift(afternoon_start, hours: :rand.uniform(4) + 2, minutes: :rand.uniform(60)))
